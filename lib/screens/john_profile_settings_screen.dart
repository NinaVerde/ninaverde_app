...
class JohnProfileSettingsScreen extends StatefulWidget {
  ...
  @override
  State<JohnProfileSettingsScreen> createState() => _JohnProfileSettingsScreenState();
}

class _JohnProfileSettingsScreenState extends State<JohnProfileSettingsScreen> {
  ...
  Future<void> _loadProfilePictures() async {
    final urls = await _service.fetchUserProfilePictures(hostId: 'john');
    if (mounted) {
      AppState.of(context).johnProfilePics.value = urls;
    }
  }
  ...
  Future<void> _pickAndUploadImage() async {
    try {
      ...
      if (app.johnProfilePics.value.length >= 20) {
        if (!mounted) return;
      ...
      // Upload
      final url = await _service.uploadProfilePicture(file, hostId: 'john');
      
      // Add to list
      final updated = List<String>.from(app.johnProfilePics.value)..add(url);
      app.johnProfilePics.value = updated;

      // If it's the first picture, auto-select it
      if (updated.length == 1) {
        app.selectedJohnProfilePic.value = url;
      }
  ...
  Future<void> _deleteImage(String url) async {
    ...
    // Remove from list
    final updated = List<String>.from(app.johnProfilePics.value)..remove(url);
    app.johnProfilePics.value = updated;

    // If deleted was selected, pick new selection
    if (app.selectedJohnProfilePic.value == url) {
      app.selectedJohnProfilePic.value = updated.isNotEmpty ? updated.first : null;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(tr(context, en: 'John Profile Pictures', es: 'Fotos de Perfil de John')),
        backgroundColor: Colors.blueGrey[900], // Darker tone for John
      ),
      body: ValueListenableBuilder<List<String>>(
        valueListenable: app.johnProfilePics,
  ...
  Widget _buildCurrentPictureSection(AppState app, ColorScheme scheme) {
    return ValueListenableBuilder<String?>(
      valueListenable: app.selectedJohnProfilePic,
                  ...
                  child: Container(
                    ...
                    child: ClipOval(
                      child: selected != null
                          ...
                          : Image.asset(
                              'assets/images/john/john_bubble_avatar.jpg',
                              fit: BoxFit.cover,
              ...
              return ValueListenableBuilder<String?>(
                ...
                builder: (context, selected, _) {
                  ...
                  return _PersonaCard(
                    ...
                    onTap: () => app.selectedJohnProfilePic.value = url,
        ...
        child: Column(
          ...
          children: [
            ...
            ValueListenableBuilder<bool>(
              valueListenable: app.johnProfilePicRandomize,
            ...
            ValueListenableBuilder<bool>(
              ...
              builder: (context, randomize, _) {
                ...
                return ValueListenableBuilder<int>(
                  valueListenable: app.johnProfilePicInterval,
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Slider(
                          ...
                          onChanged: (value) {
                            app.johnProfilePicInterval.value = value.round();
                          },
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
             if (isSelected) 
               BoxShadow(color: Colors.blueAccent.withOpacity(0.4), blurRadius: 15, spreadRadius: 2)
             else 
