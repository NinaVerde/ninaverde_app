...
// INTRO LOGO POP â†’ FLASH0 (NV) â†’ POWERED â†’ FLASH1 (Biz) â†’ BY â†’ FLASH2 (Biz)
// â†’ BIZ APPS VIDEO (enlarged + bloom + trimmed end matte) â†’ FINAL NV REVEAL â†’ Login
...
class _SplashToLoginScreenState extends State<SplashToLoginScreen>
  ...
  // Watchdog so "video" phase canâ€™t hang
                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: [
                        ...
                        // end â€œcreep killerâ€ â€” only at very bottom, shallower
                        AnimatedOpacity(
